...
// エラーコード
typedef enum {
    CVErrorCodeFailureHttp = 1000,
    CVErrorCodeFailureHttpNoRetry,
    CVErrorCodeFailureRtb,
    CVErrorCodeInvalidDisplayType,
    CVErrorCodeFailureLocation,
    CVErrorCodeErrorSystem,
} CVErrorCode;
...
@property (nonatomic, retain) id<CompassViewDelegate> delegate;
